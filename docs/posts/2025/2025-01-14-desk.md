...
```{thumb-image} _images/desk-2025-01-16-home-mexico-city.jpg
...
```{thumb-image} _images/desk-2025-02-13-home-el-calafate.jpeg
:target: https://media.githubusercontent.com/media/%(GIT_REPOSITORY)s/refs/heads/%(repository_branch)s/%(path_to_docs)s/%(fullsize_path)s
```
...
```{thumb-image} _images/desk-2025-07-14-home-sydney.jpg
:target: https://media.githubusercontent.com/media/%(GIT_REPOSITORY)s/refs/heads/%(repository_branch)s/%(path_to_docs)s/%(fullsize_path)s
```
